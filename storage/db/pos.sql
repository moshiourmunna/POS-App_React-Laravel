...
--
-- Host: localhost:3306
-- Generation Time: Feb 23, 2022 at 03:22 PM
...
(2, 'Cold Dishes', 'cold-dishes', 0, NULL, '2022-02-23 08:21:09'),
(3, 'Soup', 'soup', 0, NULL, NULL),
(4, 'Grill', 'grill', 0, NULL, NULL),
(5, 'Appetizer', 'appetizer', 0, NULL, '2022-02-23 09:08:37'),
(6, 'Dessert', 'dessert', 0, NULL, NULL),
(43, 'Experiment', 'experiment', 1, '2022-02-23 08:33:38', '2022-02-23 08:33:38');
...
CREATE TABLE `orders` (
  ...
  `deliver_method` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bill` double(8,2) DEFAULT NULL,
  `product_id` bigint(20) UNSIGNED DEFAULT NULL,
  `category_id` bigint(20) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
(3, 'Healthy noodle with spinach leaf', 'fghfgh', 'fhfgh', 'assets/images/Image3.png', 45.00, 0, 433, NULL, 4, '2022-02-20 23:08:36', '2022-02-20 23:08:36'),
...
(10, 'Beef Chilie Russian Pastry With Salami', 'beef-chilie-russian-pastry-with-salami', 'sdfsdf', 'assets/images/1645602150.png', 22.00, 0, 23, NULL, 1, '2022-02-23 01:42:30', '2022-02-23 01:42:30');
